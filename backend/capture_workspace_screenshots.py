...
def capture_screenshots():
    pages_to_screenshot = [
        ...
        },
        {
            ...
            "url": f"http://localhost:3000/?token={token}&tab=copilot",
        },
        {
            "name": "Scenario_Lab",
            "url": f"http://localhost:3000/?token={token}&tab=scenario-lab",
        },
    ]

    artifacts_dir = Path(
        r"C:\Users\statu\.gemini\antigravity\brain\2b2ae1e2-6c39-4e06-8297-8cc54ea133b6"
    )
