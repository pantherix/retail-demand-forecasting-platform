...
def seed_all():
    ...
    try:
        ...
        for r_data in roles_data:
            role = Role(
                role_name=r_data["role_name"], permissions=r_data["permissions"]
            )
            db.add(role)
            db.flush()
        ...
        users_data = [
            ...
            {
                "email": "director@retailgpt.com",
                "username": "director",
                "full_name": "Supply Director",
                "hashed_pw": hash_password("director123"),
                "role": "director",
            },
            {
                "email": "manager@retailgpt.com",
                "username": "manager",
                "full_name": "Inventory Manager",
                "hashed_pw": hash_password("manager123"),
                "role": "manager",
            },
            {
                "email": "planner@retailgpt.com",
                "username": "planner",
                "full_name": "Inventory Planner",
                "hashed_pw": hash_password("planner123"),
                "role": "planner",
            },
        ]
        ...
        suppliers_data = [
            {
                ...
                "fill_rate": 98.2,
                "contact_info": "orders@globallogistics.com",
            },
            {
                ...
                "fill_rate": 94.5,
                "contact_info": "sales@deltadist.com",
            },
            {
                "name": "Apex Wholesale",
                "lead_time_days": 3,
                ...
                "fill_rate": 99.1,
                "contact_info": "support@apexwholesale.com",
            },
            {
                ...
                "fill_rate": 97.4,
                "contact_info": "b2b@apexpharma.com",
            },
            {
                "name": "FMCG FastPack",
                "lead_time_days": 6,
                ...
                "fill_rate": 96.0,
                "contact_info": "wholesale@fmcgfast.com",
            },
        ]
        suppliers_list = []
        ...
        warehouses_data = [
            {
                "name": "Warehouse A",
                "location": "North Regional Hub (Delhi)",
                "capacity": 15000.0,
                "utilization": 42.5,
            },
            {
                "name": "Warehouse B",
                "location": "South Fulfillment Center (Bengaluru)",
                "capacity": 20000.0,
                "utilization": 58.0,
            },
            {
                "name": "Warehouse C",
                "location": "West Coast Terminal (Mumbai)",
                "capacity": 10000.0,
                "utilization": 29.5,
            },
        ]
        ...
        products_data = [
            {
                "sku": "SKU-101",
                "name": "Organic Energy Drink 250ml",
                "category": "Beverages",
            ...
            {
                "sku": "SKU-330",
                "name": "Moisturizing Face Wash 100ml",
            ...
            {
                "sku": "SKU-555",
                "name": "Whole Wheat Sliced Bread 400g",
                ...
                "reorder_point": 180.0,
                "abc_class": "A",
                "supplier_id": suppliers_list[4].id,
            },
            {
                "sku": "SKU-601",
                "name": "Premium Whey Protein Chocolate 1kg",
                "category": "Nutrition",
            ...
            },
            {
                ...
                "reorder_point": 300.0,
                "abc_class": "B",
                "supplier_id": suppliers_list[3].id,
            },
            {
                "sku": "SKU-810",
        ...
        for prod in products_list:
            ...
            while current_date <= end_date:
                ...
                multiplier = (
                    1.3 if weekday in [4, 5] else 0.9
        ...
        for prod in products_list:
            total_stock = (
                db.query(InventoryItem.current_stock)
            ...
            days_of_cover = (
                current_stock_sum / avg_daily_sales if avg_daily_sales > 0 else 999.0
            )
            ...
            if days_of_cover < 7:
                ...
                root_causes = [
                    "Stockout Imminent",
                    f"Low Days of Cover ({days_of_cover:.1f} days)",
                ...
                root_causes = [
                    "Overstock",
                    "High Carrying Costs",
                    "Forecast Variance Drop",
                ]
                reorder_qty = 0.0
                carrying_cost = (
                    (current_stock_sum - forecast_sum) * prod.unit_cost * 0.25
                )
                revenue_risk = 0.0
            ...
            risk = RiskScore(
                ...
                forecast_confidence=(
                    round(prod.forecasts[0].forecast_confidence, 1)
                    if prod.forecasts
                    else 88.5
                ),
        ...
        alerts_data = [
            {
                ...
                "type": "Stockout Risk",
                "message": "SKU-101 has critically low stock (23 units left) across all locations with only 1.2 days of cover.",
                "severity": "Critical",
                "status": "Active",
            },
            {
                "product_id": products_list[7].id,
                "type": "Stockout Risk",
                "message": "SKU-810 has critically low stock (6 units left). Stockout expected in 2.1 days.",
                "severity": "Critical",
                "status": "Active",
            },
            {
                ...
                "type": "Supplier Delay",
                "message": "Apex Wholesale reported a 3-day transit delay for SKU-330 order. Revenue exposure: ₹45,000.",
                "severity": "High",
                "status": "Active",
            },
            {
                ...
                "message": "SKU-205 current stock (1,850 units) exceeds 60-day forecast by 250%. Carrying cost at risk.",
                "severity": "Medium",
                "status": "Active",
            },
        ]
